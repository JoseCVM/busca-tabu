...
public class TS_QBFPT extends AbstractTS<Integer> {
     ...
     */
    public TS_QBFPT(Integer tenure, Integer iterations, String filename, boolean bstImp) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        TS_QBFPT tabusearch = new TS_QBFPT(10, 30000, "instances/qbf040",true);
